...
program, then we've just learned duck-typing, or jet-propulsion if you like.
...
First we said we'd try my-ruby-app.wasm in the browser

## Run Wasm in Ruby

Second we said we'd try to do something actually useful with Wasm in Ruby instead
